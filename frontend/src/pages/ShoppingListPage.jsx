...
import { CheckCheck, ExternalLink, RotateCcw, ShoppingBag } from "lucide-react";
			...
			{!activePlan ? (
				...
				>
					<ShoppingBag
						size={40}
						strokeWidth={1.2}
						style={{ color: "var(--text-3)", margin: "0 auto var(--sp-4)" }}
					/>
					<div
